...
function Lb(a,b){
    ...
    f.options={
        ...
        minChangeSize:50,
        zIndex:811213,
        items:["justifyleft","justifycenter","justifyright","justifyfull","insertorderedlist","insertunorderedlist","indent","outdent","subscript","superscript","selectall","formatblock",
        "fontname","fontsize","forecolor","hilitecolor","bold","italic","underline","strikethrough","lineheight","removeformat","image","flash","media","insertfile","table","hr","emoticons"],
